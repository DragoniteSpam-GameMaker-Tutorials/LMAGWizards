...
cluck_set_light_spot(3, c_yellow, self.active_camera.x, self.active_camera.y, self.active_camera.z, self.active_camera.xto - self.active_camera.x, self.active_camera.yto - self.active_camera.y, self.active_camera.zto - self.active_camera.z, 400, 45, 30);
cluck_set_fog(true, c_white, 1, 500, 1000);
cluck_apply(shd_deferred, self.active_camera.GetViewMat());
